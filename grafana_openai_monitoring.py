...
def chatMonitor(func, metrics_url, logs_url, metrics_username, logs_username, access_token):
    def wrapper(*args, **kwargs):
        ...
        prompt = args[1] if len(args) > 1 and isinstance(args[1], str) else kwargs.get('prompt', "No prompt provided")
